...
class VoipBackend:
    ...
    class SipAccount(IAccount):    
        ...
        def get_buddy(self, extension):
            ...
            if dest_uri not in buddies_dict: 
...
#                 #del lck
    ...
    def init_lib(self,params, notification_cb):
        ...
        if ("debug" in self.params and self.params["debug"]==False):
        ...
        if ("turn_server_address" in self.params):
        ...
        try:
            ...
            if (self.turn_server!=None):
                ...
                if "turn_server_user" in self.params:
            ...
            global transport
            if ("sip_server_transport" in self.params and self.params["sip_server_transport"]=="udp"):
