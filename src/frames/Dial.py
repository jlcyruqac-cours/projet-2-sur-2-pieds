...
class DialPage(tk.Frame):
    ...
    def backspace(self):
        self.TextNumber.set(self.TextNumber.get()[:-1])
        pass
    ...
    def setup_ui(self):
        ...
        button_1 = tk.Button(self, text="1", command=lambda: self.enter_number("1"))
        button_1.grid(row=1, column=0, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_2 = tk.Button(self, text="2", command=lambda: self.enter_number("2"))
        button_2.grid(row=1, column=1, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_3 = tk.Button(self, text="3", command=lambda: self.enter_number("3"))
        button_3.grid(row=1, column=2, sticky=("N", "S", "E", "W"), padx=(10, 10), pady=(10, 0))

        button_4 = tk.Button(self, text="4", command=lambda: self.enter_number("4"))
        button_4.grid(row=2, column=0, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_5 = tk.Button(self, text="5", command=lambda: self.enter_number("5"))
        button_5.grid(row=2, column=1, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_6 = tk.Button(self, text="6", command=lambda: self.enter_number("6"))
        button_6.grid(row=2, column=2, sticky=("N", "S", "E", "W"), padx=(10, 10), pady=(10, 0))

        button_7 = tk.Button(self, text="7", command=lambda: self.enter_number("7"))
        button_7.grid(row=3, column=0, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_8 = tk.Button(self, text="8", command=lambda: self.enter_number("8"))
        button_8.grid(row=3, column=1, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_9 = tk.Button(self, text="9", command=lambda: self.enter_number("9"))
        button_9.grid(row=3, column=2, sticky=("N", "S", "E", "W"), padx=(10, 10), pady=(10, 0))

        button_asterisk = tk.Button(self, text="*", command=lambda: self.enter_number("*"))
        button_asterisk.grid(row=4, column=0, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_0 = tk.Button(self, text="0", command=lambda: self.enter_number("0"))
        button_0.grid(row=4, column=1, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 0))
        button_pound = tk.Button(self, text="#", command=lambda: self.enter_number("#"))
        button_pound.grid(row=4, column=2, sticky=("N", "S", "E", "W"), padx=(10, 10), pady=(10, 0))

        button_settings = tk.Button(self, text="Settings", command=lambda: self.controller.show_frame("LoginPage"))
        button_settings.grid(row=5, column=0, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 10))
        button_call = tk.Button(self, text="Call", command=lambda: self.make_call())
        button_call.grid(row=5, column=1, sticky=("N", "S", "E", "W"), padx=(10, 0), pady=(10, 10))
        button_backspace = tk.Button(self, text="<", command=lambda: self.backspace())
